...
interface AntIndexHeroProps {
  /** "동학개미" | "서학개미" | "{종목명} 주주 개미" 등 — 헤더와 한줄평 사이에 박힘 */
  subject: string;
  summary?: string;
  avgAntIndex: { value: number; label: string; totalPosts: number };
  data7d?: HistoryDataPoint[];
  data30d?: HistoryDataPoint[];
  data90d?: HistoryDataPoint[];
  /** 차트 탭 좌측에 끼워넣을 시장 그룹 토글 (메인페이지 전용) */
                    ...
                    return (
                      ...
                      >
                        <div className="shrink-0">
                          ...
                          <p className="text-sm font-bold">{snap.indexLabel}</p>
                        </div>
          ...
          <section className="py-6">
            <Tabs defaultValue="7d">
              ...
              <TabsContent value="7d">
                <TimeSeriesChart data={data7d} />
              </TabsContent>
              <TabsContent value="30d">
                <TimeSeriesChart data={data30d} />
              </TabsContent>
              <TabsContent value="90d">
                <TimeSeriesChart data={data90d} />
              </TabsContent>
            </Tabs>
          </section>
        </TabsContent>
